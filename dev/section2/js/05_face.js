...
const init = () => {
  ...
  //얼굴
  const ears = new THREE.SphereGeometry(5, 32, 16);
  const ear1 = new THREE.Mesh(ears, material);
  const ear2 = new THREE.Mesh(ears, material);
  ear1.position.set(10, 10, 0);
  ear2.position.set(-10, 10, 0);
  ...
  sphere1.position.set(-5, 5, 13);
  //왼쪽눈
  const sphere2 = new THREE.Mesh(geometry_sphere, material_sphere);
  sphere2.position.set(5, 5, 13);
  //오른쪽눈

  faceGroup.add(boxMesh, cone, sphere1, sphere2, ear1, ear2);
  //얼굴 그룹에 전부 넣기
